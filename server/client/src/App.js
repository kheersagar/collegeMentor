...
function App() {
  ...
  function render(state, action) {
    ...
    if (action.type == "user" || action.type == "profile") {
      ...
      action.type == "profile"
        ? setUserDetails(action.value)
        : setUserDetails({ data: action.value });
    }
  ...
  function loggedInUserDetails(val) {
    // to get user details function perfmed in header.js and pass it to side navigation
    setUserDetails(val);
  }
        ...
        {loginStatus ? (
          ...
          <Route path="/login" exact>
            <div className="login">
              ...
              {user == "register" ? (
                <Register userHandler={changeUserHandler} />
              ) : (
                <Login login={check} userHandler={changeUserHandler} />
              )}
            </div>
          </Route>
        )}
          ...
          <Route path="/home" exact>
            ...
            <div className="home_body">
              ...
              <div className="content_main">
                {isChat ? (
                  <Chat value={isChatValue} loggedInUser={userData} />
                ) : null}
                {content == 0 || content == 1 ? (
                  <Feed post={feedState} />
                ) : content == 5 ? (
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://kheersagar.github.io/codepen-clone/"
                    className="editor_frame"
                  />
                ) : content == 4 ? (
                  <Contact />
                ) : content == 3 ? (
