...
function Header(props) {
  ...
  function HandleChange() {
    // This is a callback function, if the close button is clicked
    setIsModal(false);
  }
      ...
      <div className="header_middle">
        <div className="header_icon">
          <div
            ...
            style={{
              borderBottom:
                home_active || props.value == 0 ? "3px solid blue" : null,
            }}
          >
            <IconButton
              onClick={() => {
            ...
            >
              <HomeRoundedIcon
                fontSize="medium"
                style={{
                  color: home_active || props.value == 0 ? "blue" : null,
                }}
              />
            </IconButton>
        ...
        <div className="header_icon">
          <div
            class="tooltip"
            style={{ borderBottom: user_active ? "3px solid blue" : null }}
          >
            <IconButton
              onClick={() => {
                props.onChange(2);
            ...
            >
              <BusinessCenterRoundedIcon
                fontSize="medium"
                style={{ color: user_active ? "blue" : null }}
              />
            </IconButton>
        ...
        <div className="header_icon">
          <div
            class="tooltip"
            style={{ borderBottom: member_active ? "3px solid blue" : null }}
          >
            <IconButton
              onClick={() => {
                props.onChange(3);
            ...
            >
              <PeopleAltRoundedIcon
                fontSize="medium"
                style={{ color: member_active ? "blue" : null }}
              />
            </IconButton>
        ...
        <div className="header_icon">
          <div
            class="tooltip"
            style={{ borderBottom: Code ? "3px solid blue" : null }}
          >
            <IconButton
              onClick={() => {
                props.onChange(5);
        ...
        <div className="header_icon">
          <div
            class="tooltip"
            style={{ borderBottom: help_active ? "3px solid blue" : null }}
          >
            <IconButton
              onClick={() => {
                props.onChange(4);
            ...
            >
              <ContactSupportRoundedIcon
                fontSize="medium"
                style={{ color: help_active ? "blue" : null }}
              />
            </IconButton>
    ...
    return (
      <>
        ...
        <div
          ...
          style={{
            display:
              window.innerWidth > 640 ? "flex" : dropdown ? "flex" : "none",
          }}
        >
          <div className="header_profile">
            <IconButton
              onClick={() => {
                dispatch({ type: "profile", value: allUserDetails });
                setDropDown(false);
              }}
            >
              <Avatar
                src="https://tse1.mm.bing.net/th?id=OIP.6nCVjA0S936UiBlDUsov4QHaE9&pid=Api&P=0&w=245&h=165"
                fontSize="small"
              ></Avatar>
            </IconButton>
            <p style={{ color: "black", fontSize: "24px" }}>
              {allUserDetails ? allUserDetails.data.username : "none"}
            </p>
          </div>
          <div className="add">
            <div class="tooltip">
  ...
  function mainHeader() {
    return (
      <>
        <CSSTransition timeout={300} classNames="header">
          <div
          ...
          >
            <div className="header_left">
              <img
                src={logo}
                style={{ width: "70px", height: "50px", marginTop: "2px" }}
                onClick={() => {
                  props.onChange(1);
                  setMemberActive(false);
                  setUserActive(false);
              ...
              <div className="search_list">
                <List
                  ...
                  searchFieldEmpty={isSearchEmpty}
                />
              </div>
            </div>
